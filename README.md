...
__ВАЖНО__: `dev.js` не коммитить! Он нужен только для локальной разработки и будет содержать ваши персональные данные.
...
* Авторизация через Chorme OAuth жутко несекьюрная, всё таки имеем дело с финансовыи данными. Нужно добавить возможность регистрации по лигину и паролю с возможностью вырубить авторизацию через гугл-акк. Плюс всё же стоит перевести приложение на HTTPS.
...
| Backend            | Добавить кластеризацию                                                          |
